   ...
   Float_t         truth_Bs1_phi;
   Float_t         truth_Bs2_m;
   Float_t         truth_Bs2_pt;
   Float_t         truth_Bs2_eta;
   Float_t         truth_Bs2_phi;
   Float_t         truth_B0Ks_m;
   Float_t         truth_B0Ks_pt;
   Float_t         truth_Bstar_m;
   Float_t         truth_Bstar_pt;
   Float_t         truth_Bstar_eta;
   Float_t         truth_Bstar_phi;
   Float_t         truth_B0_m;
   Float_t         truth_B0_pt;
   Float_t         truth_B0_eta;
   Float_t         truth_B0_phi;
   Float_t         truth_Ks_m;
   Float_t         truth_Ks_pt;
   Float_t         truth_Ks_eta;
   Float_t         truth_Ks_phi;
   Float_t         truth_gam_m;
   Float_t         truth_gam_pt;
   Float_t         truth_gam_eta;
   Float_t         truth_gam_phi;
   ...
   TBranch        *b_truth_Bs1_phi;   //!
   TBranch        *b_truth_Bs2_m;   //!
   TBranch        *b_truth_Bs2_pt;   //!
   TBranch        *b_truth_Bs2_eta;   //!
   TBranch        *b_truth_Bs2_phi;   //!
   TBranch        *b_truth_B0Ks_m;   //!
   TBranch        *b_truth_B0Ks_pt;   //!
   TBranch        *b_truth_Bstar_m;   //!
   TBranch        *b_truth_Bstar_pt;   //!
   TBranch        *b_truth_Bstar_eta;   //!
   TBranch        *b_truth_Bstar_phi;   //!
   TBranch        *b_truth_B0_m;   //!
   TBranch        *b_truth_B0_pt;   //!
   TBranch        *b_truth_B0_eta;   //!
   TBranch        *b_truth_B0_phi;   //!
   TBranch        *b_truth_Ks_m;   //!
   TBranch        *b_truth_Ks_pt;   //!
   TBranch        *b_truth_Ks_eta;   //!
   TBranch        *b_truth_Ks_phi;   //!
   TBranch        *b_truth_gam_m;   //!
   TBranch        *b_truth_gam_pt;   //!
   TBranch        *b_truth_gam_eta;   //!
   TBranch        *b_truth_gam_phi;   //!
...
void Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("truth_Bs1_phi", &truth_Bs1_phi, &b_truth_Bs1_phi);
   ...
   fChain->SetBranchAddress("truth_Bs2_phi", &truth_Bs2_phi, &b_truth_Bs2_phi);
   ...
   fChain->SetBranchAddress("truth_Bstar_m", &truth_Bstar_m, &b_truth_Bstar_m);
   fChain->SetBranchAddress("truth_Bstar_pt", &truth_Bstar_pt, &b_truth_Bstar_pt);
   fChain->SetBranchAddress("truth_Bstar_eta", &truth_Bstar_eta, &b_truth_Bstar_eta);
   fChain->SetBranchAddress("truth_Bstar_phi", &truth_Bstar_phi, &b_truth_Bstar_phi);
   fChain->SetBranchAddress("truth_B0_m", &truth_B0_m, &b_truth_B0_m);
   fChain->SetBranchAddress("truth_B0_pt", &truth_B0_pt, &b_truth_B0_pt);
   fChain->SetBranchAddress("truth_B0_eta", &truth_B0_eta, &b_truth_B0_eta);
   fChain->SetBranchAddress("truth_B0_phi", &truth_B0_phi, &b_truth_B0_phi);
   fChain->SetBranchAddress("truth_Ks_m", &truth_Ks_m, &b_truth_Ks_m);
   fChain->SetBranchAddress("truth_Ks_pt", &truth_Ks_pt, &b_truth_Ks_pt);
   fChain->SetBranchAddress("truth_Ks_eta", &truth_Ks_eta, &b_truth_Ks_eta);
   fChain->SetBranchAddress("truth_Ks_phi", &truth_Ks_phi, &b_truth_Ks_phi);
   fChain->SetBranchAddress("truth_gam_m", &truth_gam_m, &b_truth_gam_m);
   fChain->SetBranchAddress("truth_gam_pt", &truth_gam_pt, &b_truth_gam_pt);
   fChain->SetBranchAddress("truth_gam_eta", &truth_gam_eta, &b_truth_gam_eta);
   fChain->SetBranchAddress("truth_gam_phi", &truth_gam_phi, &b_truth_gam_phi);
